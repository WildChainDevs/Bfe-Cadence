...
pub contract Marketplace {
    ...
    pub resource interface SalePublic {
        pub fun purchase(tokenID: UInt64, recipient: &AnyResource{BfeNFT.NFTReceiver}, buyTokens: @FUSD.Vault)
    ...
    pub resource SaleCollection: SalePublic {
        ...
        pub var forSale: @{UInt64: BfeNFT.NFT}
        ...
        access(account) let ownerVault: Capability<&AnyResource{FUSD.Receiver}>

        init (vault: Capability<&AnyResource{FUSD.Receiver}>) {
            self.forSale <- {}
            self.metadataObjs = {}
        ...
        pub fun withdraw(tokenID: UInt64): @BfeNFT.NFT {
            // remove the price
        ...
        pub fun listForSale(token: @BfeNFT.NFT, price: UFix64, metadata: {String:String}) {
            let id = token.id
    ...
    pub fun createSaleCollection(ownerVault: Capability<&AnyResource{FUSD.Receiver}>): @SaleCollection {
